...
src <- src_organism(dbpath = file.path(path, "example.sqlite"))
src
```
...
Transcript coordinates of gene symbol equal to "PTEN" or "BRCA1", and 
transcript start position between 87863438 and 87933487. 
